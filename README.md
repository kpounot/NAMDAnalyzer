...
<table>
    <tr>
        <td>
            <img src="/doc/fig/hbContinuous.png" width="250">
        </td>
        <td>
            <img src="/doc/fig/hbIntermittent.png" width="250">
        </td>
    </tr>
</table>
...
<table>
    <tr>
        <td>
            <img src="/doc/fig/msd.png" width="250">
        </td>
        <td>
            <img src="/doc/fig/bs_interFunc.png" width="250">
        </td>
        <td>
            <img src="/doc/fig/bs_EISF.png" width="250">
        </td>
        <td>
            <img src="/doc/fig/bs_scatFunc.png" width="250">
        </td>
    </tr>
</table>
